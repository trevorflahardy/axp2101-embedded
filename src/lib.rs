    ...
    I: I2c,
{
    ...
    pub fn set_dc2_voltage(&mut self, millivolt: u16) -> Result<(), Error<I::Error>> {
        ...
        if (XPOWERS_AXP2101_DCDC2_VOL1_MIN..=XPOWERS_AXP2101_DCDC2_VOL1_MAX).contains(&millivolt) {
            ...
            val |= ((millivolt - XPOWERS_AXP2101_DCDC2_VOL1_MIN)
                / XPOWERS_AXP2101_DCDC2_VOL_STEPS1) as u8;
        } else if (XPOWERS_AXP2101_DCDC2_VOL2_MIN..=XPOWERS_AXP2101_DCDC2_VOL2_MAX).contains(&millivolt) {
    ...
    pub fn get_dc2_voltage(&mut self) -> Result<u16, Error<I::Error>> {
        ...
        if val < XPOWERS_AXP2101_DCDC2_VOL_STEPS2_BASE as u8 {
            Ok((val as u16) * XPOWERS_AXP2101_DCDC2_VOL_STEPS1
    ...
    pub fn set_dc3_voltage(&mut self, millivolt: u16) -> Result<(), Error<I::Error>> {
        ...
        if (XPOWERS_AXP2101_DCDC3_VOL1_MIN..=XPOWERS_AXP2101_DCDC3_VOL1_MAX).contains(&millivolt) {
            ...
            val |= ((millivolt - XPOWERS_AXP2101_DCDC3_VOL_MIN)
                / XPOWERS_AXP2101_DCDC3_VOL_STEPS1) as u8;
        } else if (XPOWERS_AXP2101_DCDC3_VOL2_MIN..=XPOWERS_AXP2101_DCDC3_VOL2_MAX).contains(&millivolt) {
        ...
        } else if (XPOWERS_AXP2101_DCDC3_VOL3_MIN..=XPOWERS_AXP2101_DCDC3_VOL3_MAX).contains(&millivolt) {
    ...
    pub fn get_dc3_voltage(&mut self) -> Result<u16, Error<I::Error>> {
        ...
        if val < XPOWERS_AXP2101_DCDC3_VOL_STEPS2_BASE as u8 {
            Ok((val as u16) * XPOWERS_AXP2101_DCDC3_VOL_STEPS1
    ...
    pub fn set_dc4_voltage(&mut self, millivolt: u16) -> Result<(), Error<I::Error>> {
        ...
        if (XPOWERS_AXP2101_DCDC4_VOL1_MIN..=XPOWERS_AXP2101_DCDC4_VOL1_MAX).contains(&millivolt) {
            ...
            val |= ((millivolt - XPOWERS_AXP2101_DCDC4_VOL1_MIN)
                / XPOWERS_AXP2101_DCDC4_VOL_STEPS1) as u8;
        } else if (XPOWERS_AXP2101_DCDC4_VOL2_MIN..=XPOWERS_AXP2101_DCDC4_VOL2_MAX).contains(&millivolt) {
    ...
    pub fn get_dc4_voltage(&mut self) -> Result<u16, Error<I::Error>> {
        ...
        if val < XPOWERS_AXP2101_DCDC4_VOL_STEPS2_BASE as u8 {
            Ok((val as u16) * XPOWERS_AXP2101_DCDC4_VOL_STEPS1
    ...
    pub fn set_dc5_voltage(&mut self, millivolt: u16) -> Result<(), Error<I::Error>> {
        ...
        if millivolt == XPOWERS_AXP2101_DCDC5_VOL_1200MV {
            ...
            val |= ((millivolt - XPOWERS_AXP2101_DCDC5_VOL_MIN)
                / XPOWERS_AXP2101_DCDC5_VOL_STEPS) as u8;
        }
    ...
    pub fn set_cpusldo_voltage(&mut self, millivolt: u16) -> Result<(), Error<I::Error>> {
        ...
        val |= ((millivolt - XPOWERS_AXP2101_CPUSLDO_VOL_MIN)
            / XPOWERS_AXP2101_CPUSLDO_VOL_STEPS) as u8;
    ...
    pub fn set_watchdog_timeout(&mut self, timeout: WatchdogTimeout) -> Result<(), Error<I::Error>> {
    ...
    pub fn set_low_battery_warn_threshold(&mut self, percentage: u8) -> Result<(), Error<I::Error>> {
    ...
    pub fn set_sys_power_down_voltage(&mut self, millivolt: u16) -> Result<(), Error<I::Error>> {
        ...
        if !(XPOWERS_AXP2101_VSYS_VOL_THRESHOLD_MIN..=XPOWERS_AXP2101_VSYS_VOL_THRESHOLD_MAX).contains(&millivolt) {
            return Err(Error::InvalidVoltage);
        }
    ...
    pub fn set_charging_led_mode(&mut self, mode: ChargeLedMode) -> Result<(), Error<I::Error>> {
        ...
        match mode {
            ChargeLedMode::Off | ChargeLedMode::Blink1Hz | ChargeLedMode::Blink4Hz | ChargeLedMode::On => {
                val &= 0xC8;
